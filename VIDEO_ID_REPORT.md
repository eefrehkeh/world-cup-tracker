...
- Mexico vs South Africa (Jun 11) -> `r1Afsds3ZD0`  (User-provided YouTube link (https://youtu.be/r1Afsds3ZD0); opener — FOX YouTube upload never surfaced across 5 query variants)
...
- Switzerland vs Canada (Jun 24) -> `pObYkmGnk24`  (FOX 'Switzerland vs Canada Extended Highlights 🌎🏆'; Jun 24)
- Qatar vs Bosnia and Herzegovina (Jun 24) -> `mk6m1LJdkrI`  (FOX 'Bosnia and Herzegovina vs Qatar Extended Highlights 🌎🏆' (fixture reversed in tracker); Jun 24; 3-1)
- Brazil vs Morocco (Jun 13) -> `DX5wBEslnQI`  (FOX 'Brazil vs Morocco Highlights 🌎🏆' (standard); Jun 13; 1-1)
- Scotland vs Haiti (Jun 13) -> `J_2Y34vSbBA`  (FOX 'Haiti vs Scotland Extended Highlights 🌎🏆' (fixture reversed in tracker); 0-1)
...
- Paraguay vs Australia (Jun 26) -> `NdgZtyReLbY`  (FOX 'Paraguay vs Australia Extended Highlights 🌎🏆'; 0-0 (Jun 25/26))
- Germany vs Curaçao (Jun 14) -> `cGKWqfsRDgo`  (FOX 'Germany vs Curaçao Highlights 🌎🏆' (standard); Jun 14; 7-1)
- Ivory Coast vs Ecuador (Jun 14) -> `pBk8BjA-X4Y`  (FOX 'Ivory Coast vs Ecuador Highlights 🌎🏆' (standard); Jun 14; 1-0)
